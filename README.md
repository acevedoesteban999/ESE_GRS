# **Proyecto ESE_GRS**(Ernesto_Sandro_Esteban_Guanabacoa_Regla_San-José)
...
generar planos de superficies a partir de puntos, líneas y curvas 
...
## ***Importante para el desarrollo en Visual Studio***
