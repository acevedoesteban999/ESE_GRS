...
StackLoaderObject::StackLoaderObject(void)
{
	contLoaderObject=0;
    cantLoaderObject=10;
...
void StackLoaderObject::push(char*c,StackLoaderObject*slo,double R,double G,double B){
...
void StackLoaderObject::pushByTxt(char*name,StackLoaderObject*slo){
...
void StackLoaderObject::setAnguleArt1(GLfloat*angules,StackLoaderObject*slo){
...
void StackLoaderObject::RotateAndMoveArtic(int caso,StackLoaderObject*slo){
...
void StackLoaderObject::draw(StackLoaderObject*slo,int i){
	...
	else if(i<=slo->contLoaderObject) 
		{
			slo->Stack[i]->pintarse(slo->Stack[i]);
			ESE_GRS::smallEjeCoord(20);
	     }
	glPopMatrix();
	glPushMatrix();
	///////////////////////////////////////////////////////////////////
